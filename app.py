...
st.set_page_config(
    page_title="🛫 Flight price predictor",layout="centered") 
...
def render_lottie_web(filepath: str, height=300, width=300):
    ...
    components.html(f"""
        ...
        <script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script>""", height=height, width=width)

lottie_flight_path = "animations/flight_anim.json"
lottie_currency_path = "animations/currency_anim.json"
...
if st.session_state["prediction_result"] is not None and "last_inputs" in st.session_state:
    ...
    st.markdown("### 💱 Convert price to other currencies")
    render_lottie_web(lottie_currency_path, height=300, width=650)
